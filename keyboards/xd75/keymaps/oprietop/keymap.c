 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | WWW    | MYCOMP | CALC   | MAIL   | RGB_TOG| RGB HD | RGB HI | MOD-DH | P7     | P8     | P9     | M BTN3 | MW UP  | M BTN4 |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | CAPSLK | PLAY   | PREV   | NEXT   | STOP   | RGB_MOD| RGB SD | RGB SI | QWERTY | P4     | P5     | P6     | MWLEFT | MWDOWM | MWRGTH |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | MUTE   | VOL-   | VOL+   | MEDIA  | PASTE  | RGB VD | RGB VI | CUT    | P1     | P2     | P3     | M BTN1 | M UP   | M BTN2 |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        |        |        |        |        |        |        |        |        | P0     | P.     | M LEFT | M DOWN | M RGHT |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 [_FN] = { /* FUNCTION */
  { RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F11,  KC_F12,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, _______  },
  { _______, KC_WSCH, KC_MYCM, KC_CALC, KC_MAIL, RGB_TOG, RGB_HUD, RGB_HUI, TG(_CO), KC_P7,   KC_P8,   KC_P9,   KC_BTN3, KC_WH_U, KC_BTN4  },
  { KC_CAPS, KC_MPLY, KC_MPRV, KC_MNXT, KC_MSTP, RGB_MOD, RGB_SAD, RGB_SAI, TG(_QW), KC_P4,   KC_P5,   KC_P6,   KC_WH_L, KC_WH_D, KC_WH_R  },
  { _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MSEL, PASTE,   RGB_VAD, RGB_VAI, CUT,     KC_P1,   KC_P2,   KC_P3,   KC_BTN1, KC_MS_U, KC_BTN2  },
  { _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_0,    KC_PDOT, KC_MS_L, KC_MS_D, KC_MS_R  },
 }

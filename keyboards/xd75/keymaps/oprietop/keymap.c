...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_CO] = { /* COLEMAK MOD-DH*/
    ...
    { KC_LCTL, KC_LGUI, KC_LALT, KC_RALT, TT(_FN), LSSP,    KC_LEFT, KC_DOWN, KC_RGHT, RSEN,    TT(_FN), KC_CAPS, KC_RALT, KC_RGUI, KC_RCTL },
  },
  [_QW] = { /* QWERTY */
  ...
  * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  * | PRSCR  | ESC    | CUT    | WH_UP  | PASTE  | VOL +  | P7     | P8     | P9     | NEXT   | MOU_B1 | MOU_UP | MOU_B2 | MOU_B3 | MOU_B4 |
  * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  * | RGB_MOD| TAB    | WH_LE  | WH_DO  | WH_RG  | VOL -  | P4     | P5     | P6     | PREV   | MOU_LE | MOU_DO | MOU_RG | PGUP   | FN TOG |
  * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  * | RGB_TOG| LCTL   | LSFT   | LGUI   | MOU_B1 | MUTE   | P1     | P2     | P3     | PLAY   | HOME   | END    | UP     | PGDOWN |        |
  * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  ...
  */
  [_FN] = { /* FUNCTION */
    ...
    { KC_PSCR, KC_ESC,  CUT,     KC_WH_U, PASTE,   KC_VOLU, KC_P7,   KC_P8,   KC_P9,   KC_MNXT, KC_BTN1, KC_MS_U, KC_BTN2, KC_BTN3, KC_BTN4 },
    { RGB_MOD, KC_TAB,  KC_WH_L, KC_WH_D, KC_WH_R, KC_VOLD, KC_P4,   KC_P5,   KC_P6,   KC_MPRV, KC_MS_L, KC_MS_D, KC_MS_R, KC_PGUP, TG(_FN) },
    { RGB_TOG, KC_LCTL, KC_LSFT, KC_LGUI, KC_BTN1, KC_MUTE, KC_P1,   KC_P2,   KC_P3,   KC_MPLY, KC_HOME, KC_END,  KC_UP,   KC_PGDN, _______ },
    { RESET,   TG(_QW), KC_SLCK, KC_PAUS, KC_NLCK, KC_SPC,  KC_P0,   KC_PDOT, KC_PPLS, KC_PENT, KC_NLCK, KC_LEFT, KC_DOWN, KC_RGHT, _______ },
  }
};

// Runs boot tasks for keyboard22222

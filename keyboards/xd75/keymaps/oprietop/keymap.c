 ...
 */
 [_FN] = { /* FUNCTION */
  ...
  { _______, KC_WSCH, KC_MYCM, KC_CALC, KC_MAIL, _______, RGB_HUD, RGB_HUI,  TG(_CO), KC_P7,   KC_P8,   KC_P9,   KC_BTN3, KC_WH_U, KC_BTN4  },
  { KC_CAPS, KC_MPLY, KC_MPRV, KC_MNXT, KC_MSTP, _______, RGB_SAD, RGB_SAI,  TG(_QW), KC_P4,   KC_P5,   KC_P6,   KC_WH_L, KC_WH_D, KC_WH_R  },

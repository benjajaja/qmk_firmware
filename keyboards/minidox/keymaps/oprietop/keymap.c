...
[_MOVE] = LAYOUT(
  KC_ESC,  KC_CUT,  KC_COPY, KC_PASTE,_______,      _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, \
  _______, KC_BTN1, KC_BTN3, KC_BTN2, _______,      _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, \
...
[_ADJUST] =  LAYOUT( \
  ...
  RESET,   RGB_TOG, RGB_MOD, _______, _______,      _______, _______, BL_TOGG, BL_STEP, BL_BRTG, \
                    _______, _______, _______,      _______, _______, _______                    \
)
};

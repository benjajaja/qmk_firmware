...
// Ctrl+Shift Shortcuts that are awkward without this layer
#define CTRL LM(4, MOD_LCTL)
...
[0] = LAYOUT(
  ...
  CTRL,   KC_LGUI,MOD4,KC_LALT,   KC_LSPO,KC_SPC, RAISE,  KC_RSPC,KC_RALT,KC_RGUI,FNLAY,  KC_RCTL
),
/* Raise
 * .-----------------------------------------------------------------------------------.
 * |   `  |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  |   \  |
...
[2] = LAYOUT(
  ...
  KC_LSFT,_______,KC_W,   KC_E,   KC_R,   KC_T,   KC_H,   KC_J,   KC_K,   KC_L,   _______,_______,
...
/* Ctrl Shortcuts
 * These are awkward without this layer
 */
[4] = LAYOUT(
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,

 ...
 * |   [  |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |   ]  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | LCtr | LGUI | LAlt | Mod4 | Shift| Space|Ent/Ra| Shift| RALT |Onesht|  Fn  | LCtrl|
 * '-----------------------------------------------------------------------------------'
 */
[0] = LAYOUT(
  ...
  CTRL,   KC_LGUI,KC_LGUI,MOD4,   KC_LSFT,KC_SPC, RAISE,  KC_RSFT,KC_RALT,ONESHOT,FNLAY,  CTRL
),
/* Symbols layer
 * .-----------------------------------------------------------------------------------.
 * |   `  |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  |   \  |
...
[LAYER_SYMBOLS] = LAYOUT(
  ...
  KC_TILD,KC_MINS,KC_PGUP,KC_PGDN,KC_END, KC_HOME,KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,KC_EQL, KC_PIPE,

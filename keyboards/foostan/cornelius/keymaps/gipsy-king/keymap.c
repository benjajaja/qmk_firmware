...
#define LAYER_FN 2
#define LAYER_XMONAD 3
#define LAYER_SHORTCUTS 4

// Select raise layer, or enter on tap.
#define RAISE LT(LAYER_SYMBOLS, KC_ENT)
// Select xmonad layer with LAlt always on, LAlt is swapped with LGUI by the OS on any keyboard.
...
/* Qwerty base layer
 * Caps² should be swapped with Esc on all keyboards by the OS.
 * Left-GUI³ should be swapped with Left-Alt³ on all keyboards by the OS.
 * .-----------------------------------------------------------------------------------.
 ...
 * |   -  |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |   =  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI³ | Alt³ | Mod4 | Shift| Space|Ent/Ra| Shift|  Alt |Onesht|  Fn  | Ctrl |
 * '-----------------------------------------------------------------------------------'
 */
[0] = LAYOUT(
  ...
  KC_LCTL,KC_LGUI,KC_LALT,MOD4,   KC_LSFT,KC_SPC, RAISE,  KC_RSFT,KC_RALT,ONESHOT,FNLAY,  KC_RCTL
),
/* Symbols layer
 * .-----------------------------------------------------------------------------------.
 * |   `  |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  |   \  |
...
[LAYER_FN] = LAYOUT(
  ...
  KC_ESC, EMAIL_W,EMAIL,  _______,_______,_______,KC_MS_L,KC_MS_D,KC_MS_U,KC_MS_R,_______,_______,
  QK_BOOT,_______,_______,_______,_______,_______,KC_BTN1,KC_MUTE,KC_VOLD,KC_VOLU,KC_BRID,KC_BRIU,
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______
),
...
[LAYER_XMONAD] = LAYOUT(
  ...
  _______,_______,_______,_______,KC_LSFT,_______,KC_ENT, KC_LSFT,_______,_______,_______,_______
),

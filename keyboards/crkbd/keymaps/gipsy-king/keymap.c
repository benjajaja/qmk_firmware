...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WM] = LAYOUT (
    ...
    _______, _______, _______, _______, _______, KC_T,        KC_H,    KC_J,    KC_K,    KC_L,    _______, _______, \
  ...
  [_LO] = LAYOUT (
    ...
    KC_VOLD, KC_TAB,  KC_WH_L, KC_WH_D, KC_WH_R, KC_BTN3,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_END,  KC_MPRV, \
  ...
  [_RA] = LAYOUT (
    ...
    KC_GRV,  KC_1,    KC_2,  KC_3,    KC_4,    KC_5,                     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_COMM, \

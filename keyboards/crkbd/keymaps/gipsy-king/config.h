...
#define OLED_FONT_H "keyboards/crkbd/keymaps/gipsy-king/glcdfont.c"

// #define IS_PROMPT_SIDE
#ifdef IS_PROMPT_SIDE
...
#        define OLED_MATRIX_SIZE ((OLED_DISPLAY_HEIGHT + 1) / 8 * OLED_DISPLAY_WIDTH)  // 512 (compile time mathed)
#    endif
